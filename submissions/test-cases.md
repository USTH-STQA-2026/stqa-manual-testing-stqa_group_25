...
| **TC-04** | Đăng nhập thất bại do tài khoản không tồn tại | Ở trang Đăng nhập | 1. Nhập email không tồn tại.<br>2. Nhập mật khẩu bất kỳ.<br>3. Nhấn "Đăng nhập". | Email: `noone@email.com`<br>Pass: `123456` | Hiển thị thông báo lỗi "Không tìm thấy thành viên". | REQ-01 | EP |
...
| **TC-06** | Hiển thị danh sách sách và trạng thái mặc định | Đã đăng nhập | 1. Chuyển sang tab "Sách".<br>2. Quan sát danh sách sách. | (Không có) | Hiển thị đủ 20 đầu sách. BOOK003 hiển thị trạng thái "Đã mượn", BOOK001 hiển thị "Có sẵn". | REQ-02 | EP |
...
| **TC-10** | Mượn sách thành công | Đăng nhập với `MEM006` | 1. Chọn BOOK001 đang "Có sẵn".<br>2. Nhấn "Mượn sách". | Sách: `BOOK001` | Trạng thái sách chuyển thành "Đã mượn". Hệ thống sinh phiếu mượn mới. | REQ-04 | EP |
| **TC-11** | Mượn sách thất bại do sách đã có người mượn | Đăng nhập với `MEM006` | 1. Tìm BOOK003.<br>2. Kiểm tra thao tác mượn. | Sách: `BOOK003` | Nút "Mượn sách" bị vô hiệu hóa hoặc ẩn đi. | REQ-04 | EP |
| **TC-12** | Mượn sách thất bại do tài khoản bị tạm ngưng | Đăng nhập với `MEM004` (Tạm ngưng) | 1. Chọn BOOK001 đang "Có sẵn".<br>2. Nhấn "Mượn sách". | Sách: `BOOK001` | Từ chối mượn, thông báo tài khoản bị tạm ngưng. | REQ-04 | EP |
| **TC-13** | Mượn sách thất bại do tài khoản hết hạn | Đăng nhập với `MEM005` (Hết hạn) | 1. Chọn BOOK001 đang "Có sẵn".<br>2. Nhấn "Mượn sách". | Sách: `BOOK001` | Từ chối mượn, thông báo tài khoản đã hết hạn. | REQ-04 | EP |
| **TC-14** | Mượn sách thất bại do vượt quá giới hạn 3 cuốn | Đăng nhập `MEM006`, đã mượn thêm 2 sách (tổng 3) | 1. Chọn sách "Có sẵn" thứ 4.<br>2. Nhấn "Mượn sách". | Sách: `BOOK002` | Từ chối mượn, thông báo "Thành viên đã đạt giới hạn 3 sách". | REQ-04 | BVA |
| **TC-15** | Trả sách thành công (đúng hạn) | Đăng nhập `MEM006` | 1. Vào tab Mượn/Trả.<br>2. Chọn phiếu BR003.<br>3. Nhấn "Trả sách". | Phiếu: `BR003` | Sách BOOK013 chuyển về trạng thái "Có sẵn". Không có cảnh báo lỗi. | REQ-05 | EP |
| **TC-16** | Trả sách có cảnh báo quá hạn | Đăng nhập `MEM002` | 1. Vào tab Mượn/Trả.<br>2. Chọn phiếu BR001 (Quá hạn).<br>3. Nhấn "Trả sách". | Phiếu: `BR001` | Sách BOOK003 chuyển về "Có sẵn". Hiển thị cảnh báo trả sách quá hạn. | REQ-05 | BVA |
| **TC-17** | Thủ thư kiểm tra quá hạn hệ thống | Đăng nhập bằng Thủ thư | 1. Vào chức năng Thủ thư.<br>2. Nhấn "Kiểm tra quá hạn". | (Không có) | Phiếu BR001 (hạn 15/09/2024) tự động cập nhật trạng thái thành "Quá hạn". | REQ-06 | EP |
| **TC-18** | Thêm thành viên mới thành công | Đăng nhập Thủ thư, vào tab Thành viên | 1. Nhấn "Thêm thành viên".<br>2. Nhập thông tin.<br>3. Nhấn "Lưu". | Tên: `Long`, Email: `luc1f3r@library.com`, SĐT: `0987654321` | Lưu thành viên mới thành công, tài khoản mới có thể hiển thị trong DB. | REQ-07 | EP |
| **TC-19** | Thêm thành viên thất bại do email không hợp lệ | Đăng nhập Thủ thư, vào tab Thành viên | 1. Nhấn "Thêm thành viên".<br>2. Nhập email sai định dạng.<br>3. Nhấn "Lưu". | Email: `luc1f3r@domain` (Thiếu dấu chấm) | Từ chối lưu, hệ thống báo lỗi định dạng email. | REQ-07 | EP |
| **TC-20** | Thêm thành viên thất bại do trùng email | Đăng nhập Thủ thư, vào tab Thành viên | 1. Nhấn "Thêm".<br>2. Nhập email đã tồn tại.<br>3. Nhấn "Lưu". | Email: `ba.nguyen@email.com` | Từ chối lưu, thông báo lỗi email đã tồn tại. | REQ-07 | EP |
| **TC-21** | Kiểm tra quyền tra cứu phiếu mượn | Đăng nhập lần lượt Thủ thư và `MEM002` | 1. Vào tab Mượn/Trả.<br>2. Kiểm tra danh sách phiếu hiển thị. | Thủ thư và tài khoản `MEM002` | Thủ thư thấy đủ 5 phiếu. `MEM002` chỉ thấy phiếu BR001 và BR004 của chính mình. | REQ-08 | EP |
