...
| **TC-07** | Tìm kiếm sách bằng chữ thường/bình thường | Đang ở tab "Sách" | 1. Nhập từ khóa chữ thường vào ô tìm kiếm.<br>2. Nhấn "Tìm kiếm". | Từ khóa: `"lập trình"` | Hiển thị sách BOOK001 (Lập trình Flutter cơ bản) và sách BOOK009 (Nhập môn lập trình Python). | REQ-03 | EP |
| **TC-08** | Tìm kiếm sách bằng chữ toàn bộ IN HOA | Đang ở tab "Sách" | 1. Nhập từ khóa IN HOA vào ô tìm kiếm.<br>2. Nhấn "Tìm kiếm". | Từ khóa: `"FLUTTER"` | Hiển thị sách BOOK001 (Lập trình Flutter cơ bản). | REQ-03 | EP |
...
| **TC-12** | Lọc kết hợp Tìm kiếm không ra kết quả | Đang ở tab "Sách" | 1. Nhập tìm "Flutter".<br>2. Nhập lọc "Kinh tế". | Tìm: `"Flutter"`<br>Lọc: `"Kinh tế"` | Hiển thị "Không tìm thấy sách nào" do xung đột điều kiện. | REQ-03 | EP |
...
| **TC-19** | Trả sách có cảnh báo quá hạn (lần 1) | Đăng nhập bằng `biet.hoang@email.com` | 1. Vào tab Mượn/Trả.<br>2. Tìm phiếu BR003.<br>3. Nhấn "Trả sách". | Phiếu: `BR003` | Sách BOOK013 về "Có sẵn". Hiển thị cảnh báo trả sách quá hạn. | REQ-05 | EP |
| **TC-20** | Trả sách có cảnh báo quá hạn (lần 2) | Đăng nhập bằng `ba.nguyen@email.com` | 1. Vào tab Mượn/Trả.<br>2. Tìm phiếu BR001.<br>3. Nhấn "Trả sách". | Phiếu: `BR001` | Sách BOOK003 về "Có sẵn". Hiển thị cảnh báo trả sách quá hạn. | REQ-05 | BVA |
...
| **TC-22** | Thủ thư kiểm tra quá hạn hệ thống | Đăng nhập bằng `librarian@library.com` | 1. Vào Tất cả phiếu mượn.<br>2. Nhấn "Kiểm tra sách quá hạn". | (Không có) | Phiếu BR001 và BR003 tự động cập nhật trạng thái thành "Quá hạn". | REQ-06 | EP |
| **TC-23** | Thêm thành viên mới thành công | Đăng nhập bằng Thủ thư, tab Thành viên | 1. Nhấn Icon (+).<br>2. Nhập thông tin hợp lệ.<br>3. Nhấn "Lưu". | Tên: `Long`, Email: `luc1f3r@gmail.com`, SĐT: `0987654321` | Lưu thành công, thẻ thành viên mới xuất hiện trong danh sách. | REQ-07 | EP |
